...
// Login/signup temporarily disabled — see src/app/login/page.tsx for the
// full explanation. Password reset is meaningless without login, so this
// is disabled along with it. Uncomment below to restore.

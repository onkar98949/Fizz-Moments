...
export function ConstellationBuilder({ data, onChange }: SceneBuilderProps<ConstellationData>) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="constellation-title">Title</Label>
        <Input id="constellation-title" value={data.title} onChange={(e) => onChange({ ...data, title: e.target.value })} />
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="constellation-caption">Caption (optional)</Label>
        <Input
          id="constellation-caption"

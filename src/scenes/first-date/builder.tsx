...
export function FirstDateBuilder({ data, onChange }: SceneBuilderProps<FirstDateData>) {
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex flex-col gap-1.5">
          ...
          <Input id="date-location" value={data.location} onChange={(e) => onChange({ ...data, location: e.target.value })} />
        </div>
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="date-date">Date (optional)</Label>
          <Input id="date-date" value={data.date} onChange={(e) => onChange({ ...data, date: e.target.value })} />
        </div>
      </div>

      <div className="flex flex-col gap-1.5">
        <Label htmlFor="date-caption">Caption (optional)</Label>
        <Input
          id="date-caption"

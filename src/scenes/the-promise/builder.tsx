...
export function ThePromiseBuilder({ data, onChange }: SceneBuilderProps<ThePromiseData>) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="promise-quote">Quote</Label>
        <Textarea id="promise-quote" rows={3} maxLength={160} value={data.quote} onChange={(e) => onChange({ ...data, quote: e.target.value })} />
      </div>
    </div>
  );
}
